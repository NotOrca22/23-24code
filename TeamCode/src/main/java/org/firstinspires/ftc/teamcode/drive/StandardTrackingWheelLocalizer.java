...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 5.70866142; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5.78740157; // in; offset of the lateral wheel
